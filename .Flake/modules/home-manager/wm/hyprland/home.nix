{ lib, config, pkgs, ... }: {
  imports = [
    ../../apps/terminal/kitty/default.nix
  ];
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      general = {
        ...
        border_size = 2;
        layout = "dwindle";
        "col.active_border" = "0xfffff";
        "col.inactive_border" = "0xff000";
        resize_on_border = true;
      };
      group = {
        "col.border_active" = "0xfffff";
        "col.border_inactive" = "0xff095";
        "col.border_locked_active" = "0xff5435";
      };
      decoration = {
        drop_shadow = false;
        blur = {
